 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/provider_entity/{provider_entity}",
 *     "add-form" = "/admin/structure/provider_entity/add",
 *     "edit-form" = "/admin/structure/provider_entity/{provider_entity}/edit",
 *     "delete-form" = "/admin/structure/provider_entity/{provider_entity}/delete",
 *     "version-history" = "/admin/structure/provider_entity/{provider_entity}/revisions",
 *     "revision" = "/admin/structure/provider_entity/{provider_entity}/revisions/{provider_entity_revision}/view",
 *     "revision_revert" = "/admin/structure/provider_entity/{provider_entity}/revisions/{provider_entity_revision}/revert",
 *     "revision_delete" = "/admin/structure/provider_entity/{provider_entity}/revisions/{provider_entity_revision}/delete",
 *     "translation_revert" = "/admin/structure/provider_entity/{provider_entity}/revisions/{provider_entity_revision}/revert/{langcode}",
 *     "collection" = "/admin/structure/provider_entity",
 *   },
